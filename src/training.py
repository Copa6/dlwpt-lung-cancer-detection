...
class LunaTrainingApp:
    ...
    def log_metrics(self, metrics_tensor, mode, classification_threshold=0.5):
        ...
        metrics_tensor['loss/pos'] = metrics_tensor[METRICS_LOSS_IDX, pos_label_mask].mean()
        metrics_tensor['loss/neg'] = metrics_tensor[METRICS_LOSS_IDX, neg_label_mask].mean()
